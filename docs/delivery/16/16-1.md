...
- **Install**: `npx expo run:android --variant release`
- **Launch demo**: `npx uri-scheme open "soli://demo-game?auto=1" --android`
  - Use `auto=0` (or omit) if you prefer to flip the two hidden cards manually.
