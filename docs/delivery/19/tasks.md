 ...
 **Parent PBI**: [PBI 19: In-game statistics and timer controls](./prd.md)
 ...
 | :------ | :------------------------------------------------------------ | :------- | :-------------------------------------------------------------- |
| 19-1 | [Extend settings with game statistics toggles](./19-1.md) | Review | Add persisted settings controls for moves and timer visibility under a new Game Statistics section. |
