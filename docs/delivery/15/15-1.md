# [15-1] Klondike solver (deckOrder) + difficulty
...
| 2025-11-02 17:00:00 | moved_to_pbi_15 | Review | Review | Task moved from PBI 1 to PBI 15 for solver separation. | user |
...
- `node scripts/solve-klondike.js --trials=5 --strategy=atomic --useNeededRanks=true` — sanity check to ensure optional heuristic flag passes through (see task 15-4).
