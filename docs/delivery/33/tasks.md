# Tasks for PBI 33: Freeze exact Android card glyph sources across platforms

This document lists all tasks associated with PBI 33.

**Parent PBI**: [PBI 33: Freeze exact Android card glyph sources across platforms](./prd.md)
