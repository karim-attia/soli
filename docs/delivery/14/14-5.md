...
2. Create `docs/external-package-guides/react-native-reanimated.md` containing the exact references and the key configuration steps.
...
## Verification
- Created `docs/external-package-guides/react-native-reanimated.md` with dated sources and configuration steps.
